...
<body class="font-dm bg-custom-gray min-h-screen blob-bg">
    ...
    <script>
        ...
        function showToasted(message, type = 'info') {
            const toast = document.createElement('div');
            toast.className = `p-4 rounded-xl shadow-large max-w-sm animate-slide-right backdrop-blur-sm border ${getToastClasses(type)}`;
