...
<nav class="fixed bottom-0 left-0 right-0 z-50 px-4 pb-5">
    <div class="nav-container rounded-3xl py-3 px-2 flex justify-around items-center max-w-md mx-auto">
        ...
        <!-- Home -->
        <a href="index.php" class="bottom-nav-item <?php echo $current_page === 'index' ? 'active' : ''; ?> relative flex flex-col items-center py-2 px-4 rounded-2xl min-w-[60px]" data-target="home">
