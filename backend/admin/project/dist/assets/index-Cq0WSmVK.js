      ...
      e: for (var W = 0, G = N.length, er = G >>> 1; W < er; ) {
        ...
        if (0 > l(wl, z))
          yt < G && 0 > l(tr, wl)
            ? ((N[W] = tr), (N[yt] = z), (W = yt))
            : ((N[W] = wl), (N[vt] = z), (W = vt));
        else if (yt < G && 0 > l(tr, z)) (N[W] = tr), (N[yt] = z), (W = yt);
        else break e;
      }
    }
    return j;
      ...
      return (
        ...
        z > W
          ? ((N.sortIndex = z),
            ...
            n(s) === null &&
              N === n(f) &&
              (k ? (c(P), (P = -1)) : (k = !0), gl(y, z - W)))
          : ((N.sortIndex = G), t(s, N), x || w || ((x = !0), yl(E))),
        N
      );
    }),
...
function $c(e, t, n, r, l, o, i, u, s) {
  (Nn = !1), (Mr = null), Fc.apply(Uc, arguments);
}
...
function Es(e) {
  return (e = Vc(e)), e !== null ? Ns(e) : null;
}
function Ns(e) {
...
var Me = Math.clz32 ? Math.clz32 : Gc,
  Yc = Math.log,
  Xc = Math.LN2;
function Gc(e) {
...
var Fr = null;
function co(e, t, n, r) {
  if (((Fr = null), (e = Go(r)), (e = xt(e)), e !== null))
...
var jf = Qe && "TextEvent" in window && !Cn,
  Fs = Qe && (!ri || (Cn && 8 < Cn && 11 >= Cn)),
  bi = " ",
  eu = !1;
function Us(e, t) {
  switch (e) {
...
function ru() {
  _n && (_n.detachEvent("onpropertychange", Bs), (Un = _n = null));
}
function Bs(e) {
  if (e.propertyName === "value" && ll(Un)) {
    var t = [];
    As(t, Un, e, Go(e)), ks(Mf, t);
  }
}
function Of(e, t, n) {
  e === "focusin"
    ? (ru(), (_n = t), (Un = n), _n.attachEvent("onpropertychange", Bs))
    : e === "focusout" && ru();
}
function Df(e) {
  ...
  if (!e[fr]) {
    (e[fr] = !0),
      os.forEach(function (n) {
        n !== "selectionchange" && (Hf.has(n) || Ol(n, !1, e), Ol(n, !0, e));
      });
        ...
        for (var a = f, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              y !== null &&
              ((d = y),
              c !== null && ((y = On(a, c)), y != null && k.push(Vn(a, y, d)))),
            O)
          )
            break;
          a = a.return;
      ...
      e: {
        ...
        if (
          ...
          if (
            ...
            t: {
              for (k = w, c = x, a = 0, d = k; d; d = Rt(d)) a++;
...
function ht() {
  if (!Fl && Ve !== null) {
    ...
    try {
      ...
      throw (Ve !== null && (Ve = Ve.slice(e + 1)), Cs(Zo, ht), l);
    } finally {
      (R = t), (Fl = !1);
    }
  }
...
function ta(e, t, n) {
  (xe[ke++] = Be), (xe[ke++] = He), (xe[ke++] = _t), (_t = e);
  var r = Be;
  e = He;
  var l = 32 - Me(r) - 1;
  (r &= ~(1 << l)), (n += 1);
...
function la(e) {
      ...
      : a !== null &&
        (a.elementType === E ||
          (typeof E == "object" &&
            ...
            E.$$typeof === Je &&
            yu(E) === a.type))
      ? ((y = l(a, d.props)), (y.ref = vn(c, a, d)), (y.return = c), y)
  ...
  function h(c, a, d, y, E) {
    return a === null || a.tag !== 7
      ? ((a = Nt(d, c.mode, y, E)), (a.return = c), a)
      : ((a = l(a, d)), (a.return = c), a);
  }
  function m(c, a, d) {
  ...
  function p(c, a, d, y) {
    ...
    if (typeof d == "object" && d !== null) {
      ...
      if (xn(d) || fn(d)) return E !== null ? null : h(c, a, d, y, null);
      mr(c, d);
    }
    return null;
  }
  function w(c, a, d, y, E) {
    ...
    if (typeof y == "object" && y !== null) {
      switch (y.$$typeof) {
        ...
        case Je:
          var C = y._init;
          return w(c, a, d, C(y._payload), E);
      }
      if (xn(y) || fn(y)) return (c = c.get(d) || null), h(a, c, y, E, null);
      mr(a, y);
    }
    return null;
  }
  ...
  function k(c, a, d, y) {
    ...
    if (T.done) return n(c, _), U && gt(c, P), E;
    if (_ === null) {
...
function pi(e, t) {
  switch ((D(Wn, t), D(Hn, e), D($e, bn), (e = t.nodeType), e)) {
    case 9:
    case 11:
...
function yi(e, t, n, r, l, o) {
  if (
    ...
    o = 0;
    do {
      if (((jn = !1), (Qn = 0), 25 <= o)) throw Error(g(301));
      (o += 1),
        (Z = Y = null),
        (t.updateQueue = null),
        (Cr.current = od),
...
function nd(e, t, n) {
  ...
  if (Ca(e)) _a(t, l);
    ...
    (n = ia(e, t, l, r)),
      n !== null && ((l = ie()), Re(n, e, r, l), Pa(n, t, r));
  }
}
function Ca(e) {
  var t = e.alternate;
...
var Gr = {
  ...
  rd = {
    ...
    useTransition: function () {
      var e = xu(!1),
        t = e[0];
      return (e = ed.bind(null, e[1])), (Ie().memoizedState = e), [t, e];
    },
...
function No(e, t, n, r) {
  ...
  typeof o == "object" && o !== null
    ? (l.context = Ne(o))
    : ((o = de(t) ? Ct : le.current), (l.context = bt(e, o))),
...
function zu(e, t, n, r, l) {
  ...
  if ((Zt(t, l), t.stateNode === null))
    Pr(e, t), ja(t, n, r), No(t, n, r, l), (r = !0);
  else if (e === null) {
    var i = t.stateNode,
      u = t.memoizedProps;
    i.props = u;
    ...
    u !== m || p !== x || fe.current || qe
      ? (typeof w == "function" && (Eo(t, n, w, r), (x = t.memoizedState)),
        (f = qe || Su(t, n, f, r, p, x, s) || !1)
          ? (h ||
...
function sd(e, t, n, r, l, o, i) {
  if (n)
    return t.flags & 256
      ? ((t.flags &= -257), (r = Bl(Error(g(422)))), hr(e, t, i, r))
      : t.memoizedState !== null
  ...
  if (l.data === "$!") {
    ...
    return (r = u), (o = Error(g(419))), (r = Bl(o, r, void 0)), hr(e, t, i, r);
  }
  if (((u = (i & e.childLanes) !== 0), ce || u)) {
    ...
    return Pi(), (r = Bl(Error(g(421)))), hr(e, t, i, r);
  }
  return l.data === "$?"
    ? ((t.flags |= 128),
      (t.child = e.child),
  ...
  switch ((ii(t), t.tag)) {
    ...
    case 6:
      if (e && t.stateNode != null) $a(e, t, e.memoizedProps, r);
        ...
        if (((n = St(Wn.current)), St($e.current), pr(t))) {
          if (
            ((r = t.stateNode),
            (n = t.memoizedProps),
            (r[Fe] = t),
...
function Aa(e) {
  ...
  t !== null && ((e.alternate = null), Aa(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Fe], delete t[Bn], delete t[go], delete t[Gf], delete t[Zf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Re(e, t, n, r) {
  ...
  Zn(e, n, r),
    (!(M & 2) || e !== J) &&
      (e === J && (!(M & 2) && (fl |= n), X === 4 && et(e, b)),
      pe(e, r),
      n === 1 && M === 0 && !(t.mode & 1) && ((ln = Q() + 500), ul && ht()));
}
function pe(e, t) {
  ...
  if (t !== 0) {
    ...
    if (t === 6) et(e, r);
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            (et(e, r), (r & 130023424) === r && ((t = Ni + 500 - Q()), 10 < t))
          ) {
            if (Dr(e, 0) !== 0) break;
            ...
            e.timeoutHandle = yo(wt.bind(null, e, ae, Ae), t);
            break;
          }
          wt(e, ae, Ae);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = yo(wt.bind(null, e, ae, Ae), r);
            break;
          }
          wt(e, ae, Ae);
          break;
...
function zt(e) {
  ...
  try {
    ...
    (R = r), (Ee.transition = n), (M = t), !(M & 6) && ht();
  }
}
function _i() {
  (me = Qt.current), F(Qt);
...
function wt(e, t, n) {
  var r = R,
    l = Ee.transition;
  try {
    (Ee.transition = null), (R = 1), wd(e, t, n, r);
  } finally {
    (Ee.transition = l), (R = r);
  }
  return null;
  ...
  if (nt !== null) {
    ...
    try {
      if (((Ee.transition = null), (R = 16 > e ? 16 : e), nt === null))
        ...
        if (((e = nt), (nt = null), (qr = 0), M & 6)) throw Error(g(331));
        var l = M;
...
function Lr(e, t, n, r, l, o) {
  ...
  if (((r = e), typeof e == "function")) ji(e) && (i = 1);
    ...
    e: switch (e) {
      ...
      case Yl:
        return (
          (e = Se(12, n, t, l | 2)), (e.elementType = Yl), (e.lanes = o), e
        );
      case Xl:
        return (e = Se(13, n, t, l)), (e.elementType = Xl), (e.lanes = o), e;
      case Gl:
        return (e = Se(19, n, t, l)), (e.elementType = Gl), (e.lanes = o), e;
      case ss:
        return dl(n, l, o, t);
      default:
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (Jo(t, n | 1), pe(t, Q()), !(M & 6) && ((ln = Q() + 500), ht()));
      }
      break;
    case 13:
      zt(function () {
...
ws = Ci;
xs = zt;
var zd = { usingClientEntryPoint: !1, Events: [qn, $t, il, ys, gs, Ci] },
  gn = {
    ...
    const n = Te.forwardRef(
      (
        ...
        Te.createElement(
          ...
          [
            ...t.map(([m, p]) => Te.createElement(m, p)),
            ...(Array.isArray(s) ? s : [s]),
          ]
        )
    );
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */ const Id = Mt("Minus", [["path", { d: "M5 12h14", key: "1ays0h" }]]);
/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function $d() {
  const [e, t] = Te.useState([
    ...
    [n, r] = Te.useState({ email: "", firstName: "", lastName: "", phone: "" }),
    [l, o] = Te.useState({
      address: "",
      city: "",
      state: "",
    ...
    h = (c, a) => {
      t((d) =>
        d
          .map((y) =>
            y.id === c ? { ...y, quantity: Math.max(0, y.quantity + a) } : y
          )
          .filter((y) => y.quantity > 0)
      );
    },
    m = (c) => {
      t((a) => a.filter((d) => d.id !== c));
    },
    p = e.reduce((c, a) => c + a.price * a.quantity, 0),
    w = p > 50 ? 0 : 5.99,
    x = p * 0.08,
    k = p + w + x,
    O = async () => {
      f(!0),
        setTimeout(() => {
          f(!1), alert("Order placed successfully!");
        }, 2e3);
    };
  return v.jsxs("div", {
          ...
          children: v.jsxs("div", {
            ...
            children: [
              v.jsxs("button", {
                ...
                children: [
                  v.jsx(Od, { className: "w-6 h-6 mr-2" }),
                  v.jsx("span", {
                        ...
                        v.jsxs("div", {
                          children: [
                            ...
                            v.jsx("input", {
                              ...
                              value: n.firstName,
                              onChange: (c) =>
                                r((a) => ({ ...a, firstName: c.target.value })),
                              className:
                                "w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all",
                              placeholder: "John",
                            }),
                          ],
                        }),
                ...
                v.jsxs("div", {
                  ...
                  children: [
                    v.jsxs("div", {
                      ...
                      children: [
                        v.jsx(Wu, { className: "w-6 h-6 text-blue-600 mr-3" }),
                        v.jsx("h2", {
                          className: "text-xl font-bold text-gray-900",
                ...
                v.jsxs("div", {
                  ...
                  children: [
                    v.jsxs("div", {
                      className: "flex items-center mb-6",
                      children: [
                        v.jsx(Dd, { className: "w-6 h-6 text-blue-600 mr-3" }),
                        v.jsx("h2", {
                          className: "text-xl font-bold text-gray-900",
                      ...
                      children: [
                        v.jsxs("div", {
                          children: [
                            ...
                            v.jsx("input", {
                              type: "text",
                              value: i.cardholderName,
                              onChange: (c) =>
                                u((a) => ({
                                  ...a,
                                  cardholderName: c.target.value,
                                })),
                              className:
                                "w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all",
                              placeholder: "Kabri Acid",
                            }),
                          ],
                        }),
                        v.jsxs("div", {
                ...
                children: [
                            ...
                            v.jsxs("div", {
                              ...
                              children: [
                                ...
                                v.jsxs("p", {
                                  ...
                                  children: ["$", c.price.toFixed(2), " each"],
                                }),
                              ],
                            }),
                            v.jsxs("div", {
                              ...
                              children: [
                                v.jsx("button", {
                                  onClick: () => h(c.id, -1),
                                  className:
                                    "w-8 h-8 rounded-full bg-white border border-gray-300 flex items-center justify-center hover:bg-gray-100 transition-colors",
                                  children: v.jsx(Id, { className: "w-4 h-4" }),
                                }),
                                v.jsx("span", {
                                ...
                                v.jsx("button", {
                                  ...
                                  className:
                                    "w-8 h-8 rounded-full bg-white border border-gray-300 flex items-center justify-center hover:bg-gray-100 transition-colors",
                                  children: v.jsx(Fd, { className: "w-4 h-4" }),
                                }),
                              ],
                            }),
                            v.jsx("button", {
                              ...
                              children: v.jsx(Ud, { className: "w-5 h-5" }),
                            }),
                          ],
                        },
                        c.id
                  ...
                  v.jsxs("div", {
                    ...
                    children: [
                      v.jsxs("div", {
                        ...
                        children: [
                          v.jsx("span", { children: "Subtotal" }),
                          v.jsxs("span", { children: ["$", p.toFixed(2)] }),
                        ],
                      }),
                      v.jsxs("div", {
                        className: "flex justify-between text-gray-600",
                        children: [
                          v.jsx("span", { children: "Delivery Fee" }),
                          v.jsx("span", {
                            children: w === 0 ? "Free" : `$${w.toFixed(2)}`,
                          }),
                        ],
                      }),
                      v.jsxs("div", {
                        className: "flex justify-between text-gray-600",
                        children: [
                          v.jsx("span", { children: "Tax" }),
                          v.jsxs("span", { children: ["$", x.toFixed(2)] }),
                        ],
                      }),
                      v.jsx("div", {
                        ...
                        children: v.jsxs("div", {
                          className:
                            "flex justify-between text-xl font-bold text-gray-900",
                          children: [
                            v.jsx("span", { children: "Total" }),
                            v.jsxs("span", { children: ["$", k.toFixed(2)] }),
                          ],
                        }),
                      }),
                    ],
                  ...
                  v.jsx("div", {
                    ...
                    children: v.jsxs("div", {
                      ...
                      children: [
                        v.jsx(Wu, { className: "w-5 h-5 mr-2" }),
                        v.jsx("span", {
                  ...
                  v.jsx("button", {
                    ...
                    className:
                      "w-full mt-6 bg-gray-900 text-white py-4 px-6 rounded-xl font-semibold text-lg hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200",
                    children: s
                      ? v.jsxs("div", {
                      ...
                      : `Place Order • $${k.toFixed(2)}`,
                  }),
                  v.jsxs("div", {
                    className:
                      "mt-4 flex items-center justify-center text-sm text-gray-500",
                    children: [
                      v.jsx(Hu, { className: "w-4 h-4 mr-2" }),
...
rc(document.getElementById("root")).render(
  v.jsx(Te.StrictMode, { children: v.jsx($d, {}) })
);
