                ...
                <div class="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex items-center justify-center">
                    <div class="w-full max-w-md">
                        ...
                        <div class="text-center mb-6">
                            <div class="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-pink-400 to-pink-600 rounded-3xl shadow-lg flex items-center justify-center">
                                <div class="w-12 h-12 bg-white rounded-2xl flex items-center justify-center">
                                    <div class="w-6 h-6 bg-gradient-to-br from-pink-400 to-pink-600 rounded-lg"></div>
                                </div>
                            </div>
                        ...
                        <div class="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
                            <form class="space-y-6">
                                <div class="space-y-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="email" class="w-full pl-12 pr-4 py-4 bg-gray-50 border border-gray-200 rounded-2xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-pink-400 focus:border-transparent transition-all duration-200" placeholder="Enter your email" value="">
                                    </div>
                                </div>
                                <div class="space-y-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="password" class="w-full pl-12 pr-12 py-4 bg-gray-50 border border-gray-200 rounded-2xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-pink-400 focus:border-transparent transition-all duration-200" placeholder="Enter your password" value="">
                                ...
                                <div class="text-right">
                                    <button type="button" class="text-pink-500 hover:text-pink-600 text-sm font-medium transition-colors duration-200">Forgot Password?</button>
                                </div>
                                <button type="submit" class="w-full bg-gradient-to-r from-pink-500 to-pink-600 text-white py-4 rounded-2xl font-bold text-lg hover:from-pink-600 hover:to-pink-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center space-x-2">
                                    <span>Sign In</span>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <button class="flex items-center justify-center space-x-2 py-3 px-4 bg-gray-50 hover:bg-gray-100 rounded-2xl transition-colors duration-200 border border-gray-200">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-apple w-5 h-5 text-gray-600">
